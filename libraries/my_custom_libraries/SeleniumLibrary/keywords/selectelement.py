...
from ..utils import is_truthy, plural_or_not
...
class SelectElementKeywords(LibraryComponent):
    ...
    def get_selected_list_labels(self, locator: Locator) -> list[str]:
        ...
        Starting from libraries.selenium_library.3.0, returns an empty list if there
    ...
    def list_selection_should_be(self, locator: Locator, *expected: str):
        ...
        as values. Starting from libraries.selenium_library.3.0, mixing labels and
